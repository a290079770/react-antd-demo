...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)(_reducer.fn);
	//action
	...
	(0, _jquery2.default)('#ulContent').on('click', 'li', function () {
	  ...
	  e.preventDefault();
	  data.showType = (0, _jquery2.default)(this).text();
	  render(data);
	});
	
	(0, _jquery2.default)('#addBtn').on('click', function () {
	  data.todolist.push({
	    id: data.index,
	    text: (0, _jquery2.default)('input').val(),
	    completed: false
	  });
	...
	function render(data) {
	  ...
	  (0, _jquery2.default)('#ulContent').html(str);
	}
