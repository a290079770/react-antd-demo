...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reg = __webpack_require__(1065);
	
	var _reg2 = _interopRequireDefault(_reg);
	
	var _info = __webpack_require__(1066);
	
	var _info2 = _interopRequireDefault(_info);
	
	var _commodity = __webpack_require__(1067);
	
	var _commodity2 = _interopRequireDefault(_commodity);
	
	var _addCommodity = __webpack_require__(1068);
	
	var _addCommodity2 = _interopRequireDefault(_addCommodity);
	
	var _getCommodity = __webpack_require__(1069);
	
	var _getCommodity2 = _interopRequireDefault(_getCommodity);
	
	var _emp = __webpack_require__(1072);
	
	var _emp2 = _interopRequireDefault(_emp);
	
	var _showEmp = __webpack_require__(1073);
	
	var _showEmp2 = _interopRequireDefault(_showEmp);
	
	var _searchEmp = __webpack_require__(1074);
	
	var _searchEmp2 = _interopRequireDefault(_searchEmp);
	
	var _addEmp = __webpack_require__(1075);
	
	var _addEmp2 = _interopRequireDefault(_addEmp);
	
	var _addCommodityImgs = __webpack_require__(1078);
	
	var _addCommodityImgs2 = _interopRequireDefault(_addCommodityImgs);
	...
	_reactDom2.default.render(_react2.default.createElement(
	     ...
	     _react2.default.createElement(_reactRouter.Route, { path: '/login/:email', component: _login2.default }),
	     ...
	     _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	               _reactRouter.Route,
	               { path: 'commodity', component: _commodity2.default },
	               _react2.default.createElement(_reactRouter.IndexRoute, { component: _addCommodity2.default }),
	               _react2.default.createElement(_reactRouter.Route, { path: 'addCommodity', component: _addCommodity2.default }),
	               _react2.default.createElement(_reactRouter.Route, { path: 'getCommodity', component: _getCommodity2.default }),
	               _react2.default.createElement(_reactRouter.Route, { path: 'addCommodityImgs/:commId', component: _addCommodityImgs2.default })
	          ),
	          _react2.default.createElement(
	               _reactRouter.Route,
	               { path: 'emp', component: _emp2.default },
	               _react2.default.createElement(_reactRouter.Route, { path: 'showEmp', component: _showEmp2.default }),
	               _react2.default.createElement(_reactRouter.Route, { path: 'addEmp', component: _addEmp2.default }),
	               _react2.default.createElement(_reactRouter.Route, { path: 'searchEmp', component: _searchEmp2.default })
	          )
	     )
	), app);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _antd = __webpack_require__(322);
	...
	var Login = function (_React$Component) {
		...
		function Login(props) {
			...
			_this.state = {
				email: _this.props.params.email ? _this.props.params.email : 'hello'
			};
			return _this;
		}
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
									...
									getFieldDecorator('password', {
										rules: [{
											...
											validator: function validator(rule, value, callback) {
												return _this2.checkConfirm(rule, value, callback);
											}
										}]
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										_antd.Button,
										{ type: 'primary', htmlType: 'button', size: 'large', onClick: function onClick(e) {
									...
									_react2.default.createElement(
										_antd.Button,
										{ type: 'primary', style: { marginLeft: 20 }, htmlType: 'button', size: 'large', onClick: function onClick() {
...
/***/ function(module, exports, __webpack_require__) {
						...
						fetch("/users/reg", {
							...
							if (eval(data)) {
								_antd.Modal.success({
									...
									content: '点击去登录！',
									onOk: function onOk() {
										_reactRouter.hashHistory.push('/login/' + values.userName);
									}
								});
							} else {
								_antd.Modal.error({
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									getFieldDecorator('password', {
										rules: [{
											...
											validator: function validator(rule, value, callback) {
												return _this3.checkConfirm(rule, value, callback);
											}
										}]
									})(_react2.default.createElement(_antd.Input, { type: 'password', onBlur: function onBlur(e) {
											return _this3.handlePasswordBlur(e);
										} }))
								),
								_react2.default.createElement(
									FormItem,
									...
									getFieldDecorator('confirm', {
										rules: [{
											...
											validator: function validator(rule, value, callback) {
												return _this3.checkPassowrd(rule, value, callback);
											}
										}]
									})(_react2.default.createElement(_antd.Input, { type: 'password' }))
								),
								_react2.default.createElement(
									...
									_react2.default.createElement(
										_antd.Button,
										{ type: 'primary', htmlType: 'button', size: 'large', disabled: this.state.disAbled, onClick: function onClick(e) {
									...
									_react2.default.createElement(
										_antd.Button,
										{ type: 'primary', htmlType: 'button', size: 'large', style: { marginLeft: 20 }, onClick: function onClick() {
	...
	exports.default = _antd.Form.create()(Reg);
	...
	var Info = function (_React$Component) {
		...
		_createClass(Info, [{
			...
			value: function handleClick(key) {
				...
				_reactRouter.hashHistory.push('/info/' + key.key);
			}
		}, {
			key: 'render',
			value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Commodity = function (_React$Component) {
		...
		function Commodity(props) {
			...
			var _this = _possibleConstructorReturn(this, (Commodity.__proto__ || Object.getPrototypeOf(Commodity)).call(this, props));
		...
		_createClass(Commodity, [{
			...
			value: function handleClick(key) {
				...
				_reactRouter.hashHistory.push('/info/commodity/' + key.key);
			}
		}, {
			key: 'render',
			value: function render() {
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									_antd.Menu.Item,
									{ key: 'getCommodity' },
									_react2.default.createElement(_antd.Icon, { type: 'windows-o' }),
									'\u67E5\u770B\u5546\u54C1'
								)
							)
						),
...
/***/ function(module, exports, __webpack_require__) {
				...
				this.props.form.validateFieldsAndScroll(function (err, values) {
					if (!err) {
						fetch("/commodity/addCommodity", {
							...
							body: 'commodity=' + JSON.stringify(_this2.state),
							credentials: 'include'
						}).then(function (response) {
							return response.json();
						}).then(function (data) {
							if (data) {
								_antd.message.success('添加商品完成，请上传图片！');
								_this2.setState({
									commPicUpload: false,
									commId: data
								});
			...
			value: function render() {
				...
				for (var i = 0; i < sizeValue.length; i++) {
					size.push(_react2.default.createElement(
						Option,
						{ key: i + 'option', value: sizeValue[i] },
						sizeValue[i]
					));
				}
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							})(_react2.default.createElement(_antd.Input, { type: 'number', style: { width: 200 }, onBlur: function onBlur(e) {
									return _this3.setCommPrice(e);
								} }))
						),
						_react2.default.createElement(
							FormItem,
							...
							_react2.default.createElement(
								...
								{ defaultValue: '\u7537\u978B',
									...
									onChange: function onChange(value) {
										return _this3.handleChangeType(value);
									}
								},
								_react2.default.createElement(
									Option,
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_antd.Select,
								{
									...
									onChange: function onChange(value) {
										return _this3.handleChangeSize(value);
									}
								},
								size
							)
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_antd.Button,
								{ type: 'primary', htmlType: 'button', size: 'large', disabled: this.state.commPicUpload, onClick: function onClick() {
										return _reactRouter.hashHistory.push('/info/commodity/addCommodityImgs/' + _this3.state.commId);
									} },
								'\u4E0A\u4F20\u56FE\u7247'
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_antd.Button,
								{ type: 'primary', htmlType: 'button', size: 'large', disabled: !this.state.commPicUpload, onClick: function onClick(e) {
										return _this3.handleSubmit(e);
									} },
								'\u4FDD\u5B58'
							)
	...
	exports.default = _antd.Form.create()(AddCommodity);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GetCommodity = function (_React$Component) {
		_inherits(GetCommodity, _React$Component);
	
		function GetCommodity(props) {
			_classCallCheck(this, GetCommodity);
	
			var _this = _possibleConstructorReturn(this, (GetCommodity.__proto__ || Object.getPrototypeOf(GetCommodity)).call(this, props));
		...
		_createClass(GetCommodity, [{
			key: 'componentWillMount',
			value: function componentWillMount() {
				this.getCommodityByPage();
			}
		}, {
			key: 'getCommodityByPage',
			value: function getCommodityByPage() {
				var _this2 = this;
			...
			value: function showPics(index) {
				_reactRouter.hashHistory.push('/info/commodity/addCommodityImgs/' + index._id);
			}
		}, {
			key: 'delCommodity',
			value: function delCommodity(index) {
				var _this3 = this;
			...
			value: function render() {
				...
				var columns = [{
					...
					render: function render(record, index) {
						return _react2.default.createElement(
							...
							_react2.default.createElement(
								_antd.Popconfirm,
								{ title: '\u786E\u5B9A\u5220\u9664\u8BE5\u5546\u54C1\u6240\u6709\u4FE1\u606F?', onConfirm: function onConfirm() {
										return _this4.delCommodity(index);
									} },
								_react2.default.createElement(
									_antd.Button,
				...
				var pagination = {
					...
					onShowSizeChange: function onShowSizeChange(current, pageSize) {
						_this4.getCommodityByPage({ curPage: current, eachPage: pageSize });
						_this4.setState({ eachPage: pageSize });
					},
					onChange: function onChange(current) {
						console.log('Current: ', current);
						_this4.getCommodityByPage({ curPage: current, eachPage: _this4.state.eachPage });
					}
				};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "th span{\r\n\ttext-align: center;\r\n\tmargin: 0 auto;\r\n}\r\ntd{text-align: left;}\r\nth,td{\r\n\twidth: 150px;\r\n}\r\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emp = function (_React$Component) {
		...
		function Emp(props) {
			...
			var _this = _possibleConstructorReturn(this, (Emp.__proto__ || Object.getPrototypeOf(Emp)).call(this, props));
		...
		_createClass(Emp, [{
			...
			value: function handleClick(key) {
				...
				_reactRouter.hashHistory.push('/info/emp/' + key.key);
			}
		}, {
			key: 'render',
			value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ShowEmp = function (_React$Component) {
		_inherits(ShowEmp, _React$Component);
	
		function ShowEmp(props) {
			_classCallCheck(this, ShowEmp);
	
			var _this = _possibleConstructorReturn(this, (ShowEmp.__proto__ || Object.getPrototypeOf(ShowEmp)).call(this, props));
			...
			value: function render() {
				...
				var pagination = {
					...
					onShowSizeChange: function onShowSizeChange(current, pageSize) {
						...
						_this3.getEmpByPage({ curPage: current, eachPage: pageSize });
					},
					onChange: function onChange(current) {
						console.log('Current: ', current);
						_this3.getEmpByPage({ curPage: current });
					}
				};
		...
		_createClass(SearchEmp, [{
			...
			value: function render() {
				...
				var selectBefore = _react2.default.createElement(
					_antd.Select,
					{ defaultValue: 'empName', style: { width: 80 } },
					_react2.default.createElement(
						Option,
						{ value: 'empName' },
						'\u6309\u59D3\u540D'
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								null,
								_react2.default.createElement(_antd.Input, { ref: 'searchInfo', addonBefore: selectBefore,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _city = __webpack_require__(1076);
	...
	var AddEmp = function (_React$Component) {
		...
		function AddEmp(props) {
			...
			var _this = _possibleConstructorReturn(this, (AddEmp.__proto__ || Object.getPrototypeOf(AddEmp)).call(this, props));
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							getFieldDecorator('empName', {
								...
								'div',
								null,
								_react2.default.createElement(_antd.Input, { style: { width: 50 + '%' } })
							))
						),
						_react2.default.createElement(
							FormItem,
						...
						_react2.default.createElement(
							...
							getFieldDecorator('empAge', {
								...
								'div',
								null,
								_react2.default.createElement(_antd.Input, { type: 'number', style: { width: 50 + '%', marginRight: 10 } })
							))
						),
						_react2.default.createElement(
							FormItem,
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_antd.Button,
								{ type: 'primary', htmlType: 'button', size: 'large', disabled: !this.state.commPicUpload, onClick: function onClick() {
										return _reactRouter.hashHistory.push('/info/commodity/addCommodityImgs');
									} },
								'\u5458\u5DE5\u7167\u7247'
							)
						),
	...
	exports.default = _antd.Form.create()(AddEmp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Option = _antd.Select.Option;
	var provinceData = ['浙江省', '江苏省', '北京市', '上海市', '重庆市', '天津市', '河北省', '山西省', '辽宁省', '吉林省', '黑龙江省', '安徽省', '福建省', '江西省', '山东省', '河南省', '湖北省', '广东省', '海南省', '四川省', '贵州省', '云南省', '陕西省', '甘肃省', '青海省', '台湾省', '内蒙古自治区', '广西壮族自治区', '西藏自治区', '宁夏回族自治区', '新疆维吾尔族自治区', '香港特别行政区', '澳门特别行政区'];
	var cityData = {
	...
	var City = function (_React$Component) {
	  ...
	  _createClass(City, [{
	    ...
	    key: 'onSecondCityChange',
	    value: function onSecondCityChange(value) {
	      this.setState({
	        secondCity: value
	      });
	    }
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _antd.Select,
	          { defaultValue: provinceData[0], style: { width: 100, marginRight: 10 }, onChange: function onChange(value) {
	        ...
	        _react2.default.createElement(
	          _antd.Select,
	          { value: this.state.secondCity, style: { width: 90 }, onChange: function onChange(value) {
	              return _this2.onSecondCityChange(value);
	            } },
	          cityOptions
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GenderRadio = function (_React$Component) {
		_inherits(GenderRadio, _React$Component);
	
		function GenderRadio(props) {
			_classCallCheck(this, GenderRadio);
	
			var _this = _possibleConstructorReturn(this, (GenderRadio.__proto__ || Object.getPrototypeOf(GenderRadio)).call(this, props));
		...
		_createClass(GenderRadio, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					RadioGroup,
					{ style: { width: 50 + '%' }, onChange: function onChange(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fileList = __webpack_require__(1079);
	...
	var AddCommodityImgs = function (_React$Component) {
		_inherits(AddCommodityImgs, _React$Component);
	
		function AddCommodityImgs(props) {
			_classCallCheck(this, AddCommodityImgs);
	
			var _this = _possibleConstructorReturn(this, (AddCommodityImgs.__proto__ || Object.getPrototypeOf(AddCommodityImgs)).call(this, props));
			...
			value: function render() {
				...
				var props = {
					...
					beforeUpload: function beforeUpload(file, fileList) {
						return fetch("/files/isExist", {
							...
							body: 'commId=' + _this3.state.commId + '&imgType=' + _this3.state.imgType + '&name=' + file.name,
							credentials: 'include'
						}).then(function (response) {
							return response.json();
						}).then(function (data) {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_fileList2.default, { getCommImgsByPage: function getCommImgsByPage(page) {
							return _this3.getCommImgsByPage(page);
						}, count: this.state.count, data: this.state.fileList, commId: this.state.commId })
				);
			}
		}]);
	
		return AddCommodityImgs;
	}(_react2.default.Component);
	
	exports.default = AddCommodityImgs;
		...
		_createClass(FileList, [{
			...
			value: function render() {
				...
				var pagination = {
					...
					onShowSizeChange: function onShowSizeChange(current, pageSize) {
						console.log('Current: ', current, '; PageSize: ', pageSize);
						_this2.props.getCommImgsByPage({
							curPage: current,
							eachPage: pageSize,
							commId: _this2.props.commId
						});
					},
					onChange: function onChange(current) {
						_this2.props.getCommImgsByPage({
